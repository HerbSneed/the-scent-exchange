...
var TickerList = function (props) {
    var animation = props.slideSpeed ? "scroll ".concat(props.slideSpeed, "s linear infinite") : 'scroll 15s linear infinite';
    return (React__namespace.createElement("div", { className: styles.ticker },
        React__namespace.createElement("div", { style: { animation: animation, display: "flex" } },
            React__namespace.createElement("div", { className: styles['ticker-list'] }, props.children),
            !props.isNewsTicker ? React__namespace.createElement("div", { className: styles['ticker-list'], "aria-hidden": true }, props.children) : '')));
};

var css_248z = "@keyframes scroll {\n  from {\n    transform: translateX(0);\n  }\n\n  to {\n    transform: translateX(calc(-100% - var(--gap)));\n  }\n}\n";
